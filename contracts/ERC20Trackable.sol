...
abstract contract ERC20Trackable is ERC20, ERC20Permit, ERC20VotesComp {
    ...
    mapping(address => CommonStructs.BalanceUpdateCommit[]) private _balanceUpdateHistory;  // TODO: 접근 제어자 지정 (public?) or/ getter view 함수 지정
    ...
    function getBalanceUpdateHistoryByAddress(address _userAddress) public view returns (CommonStructs.BalanceUpdateCommit[] memory) {
